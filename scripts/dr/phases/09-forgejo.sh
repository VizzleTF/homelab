...
# forgejo-data-rwo: git-репозитории, LFS и conf. Владелец файлов — uid 1000.
volsync_restore forgejo forgejo forgejo-data-rwo 10Gi ReadWriteOnce 1000

wait_for "forgejo-data-rwo PVC Bound"   "kubectl -n forgejo get pvc forgejo-data-rwo -o jsonpath='{.status.phase}' | grep -q Bound"   120
